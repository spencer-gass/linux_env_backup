...
plugins=(git vi-mode z zsh-autosuggestions zsh-syntax-highlighting zsh-history-substring-search direnv)

# Uncomment to include zsh completions that are in development
