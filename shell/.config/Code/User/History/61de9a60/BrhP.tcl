...
puts "DBG-SRG saved post script for later reference: [dict get $soc_build_synth_hooks STEPS.SYNTH_DESIGN.TCL.POST]"
puts "DBG-SRG: post-script, pre-change [get_property STEPS.SYNTH_DESIGN.TCL.POST [get_runs synth_1]]"
...
close $soc_build_fp
puts "DBG-SRG: post-script, post-change [get_property STEPS.SYNTH_DESIGN.TCL.POST [get_runs synth_1]]"
