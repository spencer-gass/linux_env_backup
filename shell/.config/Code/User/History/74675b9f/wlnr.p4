...
struct user_metadata {
    ...
    MplsLabelValidVec newMplsValidl;
}
    ...
    *************************************************************************/
    ...
    apply {
        ...
        if (meta.update_mpls == 1) {
            label_index = 0;
            if (meta.MplsLabelValidVec[0]) {
                new_mpls_stack.
                new_mpls_stack[label_index].label = MplsLabelStackVec[31:12];
                new_mpls_stack[label_index].exp   = MplsLabelStackVec[11:9];
                new_mpls_stack[label_index].bos   = MplsLabelStackVec[8];
                new_mpls_stack[label_index].ttl   = MplsLabelStackVec[7:0];
                label_index += 1;
            }
        }
