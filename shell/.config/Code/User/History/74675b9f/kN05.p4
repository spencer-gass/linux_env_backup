    ...
    apply {
        ...
        if (meta.update_mpls == 1) {
            ...
            if (meta.MplsLabelValidVec[0]) {
                new_mpls_stack.
                new_mpls_stack[0].label = MplsLabelStackVec[31:12];
                new_mpls_stack[0].exp   = MplsLabelStackVec[11:9];
                new_mpls_stack[0].bos   = MplsLabelStackVec[8];
                new_mpls_stack[0].ttl   = MplsLabelStackVec[7:0];
            }
        }
