    ...
    *************************************************************************/
    ...
    apply {
        ...
        if (meta.update_mpls == 1) {
            label_index = 0;
            if (meta.newMplsValid[0] & w8x01) {
                new_mpls_stack.
                new_mpls_stack[label_index].label = meta.newMplsStack[31:12];
                new_mpls_stack[label_index].exp   = meta.newMplsStack[11:9];
                new_mpls_stack[label_index].bos   = meta.newMplsStack[8];
                new_mpls_stack[label_index].ttl   = meta.newMplsStack[7:0];
