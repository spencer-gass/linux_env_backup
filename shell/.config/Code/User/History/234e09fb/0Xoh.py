...
def create_testbench(vu, lib, project_path, **kwargs):  # pylint: disable=unused-argument
    ...
    sources = [
            ...
            "sim/mpls/mpls_tb_pkg.sv",
            "rtl/mpls/mpls_router_pkg.sv",
            "rtl/mpls/mpls_egress_port_array_adapt.sv",
            "rtl/mpls/mpls_egress.sv",
            "sim/mpls/mpls_egress_tb.sv",
    ...
    tb = lib.test_bench("mpls_egress_tb")
