...
class Dvbs2xTxSymbRateMmiAddrs(IntEnum):
    """
    MMI register addresses for dvbs2x_tx_symb_rate_divider_mmi
    """
...
class Dvbs2xTxSymbRateMmi():
    ...
    symb_rate_div = MMIDesc(name="_symb_rate_div", addr=Dvbs2xTxSymbRateAddrs.ADDR_SYMB_RATE)
