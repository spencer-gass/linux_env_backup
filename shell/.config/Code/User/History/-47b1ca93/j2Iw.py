...
def create_testbench(vu, lib, project_path, **kwargs):  # pylint: disable=unused-argument
    ...
    sources = [
            ...
            "sim/p4_router/avmm_to_axi4lite_vnp4_control_sim.sv",
            "sim/p4_router/vitis_net_p4_frr_10G_pkg.sv",
            "sim/p4_router/vnp4_control_sim.sv",
            "sim/p4_router/vnp4_sim_pkg.sv",
            ...
            "sim/p4_router/vitis_net_p4_echo_phys_port_sim_netlist.v",
            "sim/p4_router/interfaces.sv",
            "sim/p4_router/reset_macros.sv",
    ...
    shared_lib_path = str(Path(project_path) / "sim/p4_router/vitisnetp4_drv_dpi")
    vu.set_sim_option("modelsim.vsim_flags", ["-sv_lib", shared_lib_path])
    # # Include Xilinx provided DPI library for VNP4 table config
    # filename = str(Path(project_path) / "sim/p4_router/vitisnetp4_drv_dpi.so")
    # sourcefile = dpilib.add_source_file(
    #         filename,
    #         include_dirs=[project_path],
    #         no_parse=True,
