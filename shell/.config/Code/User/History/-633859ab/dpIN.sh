...
cp $VNP$_DIR project-spec/meta-user/recipes-net/new_frr_stuf/files/vnp4.zip project-spec/meta-user/recipes-net/frr_dplane/files/vnp4_runtime_driver.zip