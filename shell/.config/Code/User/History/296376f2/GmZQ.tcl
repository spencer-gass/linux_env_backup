...
proc ::kepler::vivado::ips::vnp4_absolute_to_relative_path {ip ipdef property_name ip_info} {
    puts $property_name
...
proc ::kepler::vivado::ips::export_ip_info {ip_name args} {
    ...
    ::kepler::vivado::ips::vnp4_absolute_to_relative_path $ip $ipdef $proj_dir "CONFIG.P4_FILE"
    ::kepler::vivado::ips::vnp4_absolute_to_relative_path $ip $ipdef $proj_dir "CONFIG.JSON_FILE"
