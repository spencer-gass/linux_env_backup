...
\documentclass[8pt]{deedy-resume-reversed}
\usepackage{fancyhdr}
...
\begin{tightemize}
\item Subject matter expert on network hardware. Giving technical presentations to the R\&D organization,
providing guidance to technical leadership to support the creation of next generation satellite network architecture.
