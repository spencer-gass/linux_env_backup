...
control MetadataMap(inout headers hdr,
    ...
    apply {
        ...
        meta.version   = hdr.ipv4.version;
        meta.hdr_len   = hdr.ipv4.hdr_len;
        meta.tos       = hdr.ipv4.tos;
        meta.length    = hdr.ipv4.length;
        meta.id        = hdr.ipv4.id;
        meta.flags     = hdr.ipv4.flags;
        meta.offset    = hdr.ipv4.offset;
        meta.ttl       = hdr.ipv4.ttl;
        meta.protocol  = hdr.ipv4.protocol;
        meta.hdr_chk   = hdr.ipv4.hdr_chk;
        meta.src       = hdr.ipv4.src;
        meta.dst       = hdr.ipv4.dst;
