...
class TinyBcamAvmm(AvmmCommonCtrl):
    ...
    def __init__(self, sdr_host, offset, key_bits, action_id_bits, action_param_bits, action_param_names num_rows):
        """
        ...
        Params:
            ...
            action_param_bits (list of ints): number of bits in each action param
            action_param_names (list of strs): names of the action params
...
def configure_vnp4_cams(sdr):
    cam_names = [
        "vnp4_intf_map",
        "vnp4_lfib",
        "vnp4_ipv4_fib_ingress",
        "vnp4_cmp_ipv4_fib",
        "vnp4_cmp_mac_fib",
        "vnp4_vlan_map",
    ]
    ...
    (AVMM_OFFSETS.VNP4 + 0x2000, 10, 2, 46, 32)],
    (AVMM_OFFSETS.VNP4 + 0x4000, 20, 3, 161, 32)],
    (AVMM_OFFSETS.VNP4 + 0x6000, 64, 3, 149, 32)],
    (AVMM_OFFSETS.VNP4 + 0x8000, 74, 2, 14, 32)],
    (AVMM_OFFSETS.VNP4 + 0xA000, 58, 2, 14, 32)],
    (AVMM_OFFSETS.VNP4 + 0xC000, 12, 2, 12, 32)],