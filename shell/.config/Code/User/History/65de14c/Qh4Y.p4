...
control FRRdplaneIngress(inout headers hdr,
    ...
    *************************************************************************/
    ...
    action ler_push (MplsLabel out_stack0,
    MplsLabel out_stack1,
    MplsLabel out_stack2,
    MplsLabel out_stack3,
    MplsLabel out_stack4,
    MplsLabel out_stack5,
    MplsLabel out_stack6,
    MplsLabel out_stack7,
     MacAddr src_addr, MacAddr dst_addr, PortId port) {
        /* Ethernet */
        hdr.eth.src = src_addr;
        hdr.eth.dst = dst_addr;
        hdr.eth.type = TYPE_MPLS;
        ...
        hdr.mpls[0].label = out_stack0; // NOTE(jjardim): single or label stack?
        hdr.mpls[0].bos = 0;
        hdr.mpls[0].ttl = 64;
    ...
    action lsr_push(MplsLabel out_label0,
    MplsLabel out_label1,
    MplsLabel out_label2,
    MplsLabel out_label3,
    MplsLabel out_label4,
    MplsLabel out_label5,
    MplsLabel out_label6,
    MplsLabel out_label7, MacAddr src_addr, MacAddr dst_addr, PortId port) {
        /* Ethernet */
        hdr.eth.src = src_addr;
        hdr.eth.dst = dst_addr;
