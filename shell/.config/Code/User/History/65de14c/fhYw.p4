...
control FRRdplaneIngress(inout headers hdr,
    ...
    *************************************************************************/
    ...
    action ler_push (MplsLabel0 out_stack, MplsLabel1 out_stack, MplsLabel2 out_stack, MplsLabel3 out_stack, MplsLabel4 out_stack, MplsLabel5 out_stack, MplsLabel6 out_stack, MplsLabel7 out_stack, MacAddr src_addr, MacAddr dst_addr, PortId port) {
        /* Ethernet */
        hdr.eth.src = src_addr;
        hdr.eth.dst = dst_addr;
        hdr.eth.type = TYPE_MPLS;
    ...
    action lsr_push(MplsLabel0 out_stack, MplsLabel1 out_stack, MplsLabel2 out_stack, MplsLabel3 out_stack, MplsLabel4 out_stack, MplsLabel5 out_stack, MplsLabel6 out_stack, MplsLabel7 out_stack, MacAddr src_addr, MacAddr dst_addr, PortId port) {
        /* Ethernet */
        hdr.eth.src = src_addr;
        hdr.eth.dst = dst_addr;
