...
parser FRRdplaneParser(packet_in packet,
    ...
    state start {
        ...
        // IPv4
        hdr.ipv4.version     = meta.ipv4.version;
        hdr.ipv4.hdr_len     = meta.ipv4.hdr_len;
        hdr.ipv4.tos         = meta.ipv4.tos;
        hdr.ipv4.length      = meta.ipv4.length;
        hdr.ipv4.id          = meta.ipv4.id;
        hdr.ipv4.flags       = meta.ipv4.flags;
        hdr.ipv4.offset      = meta.ipv4.offset;
        hdr.ipv4.ttl         = meta.ipv4.ttl;
        hdr.ipv4.protocol    = meta.ipv4.protocol;
        hdr.ipv4.hdr_chk     = meta.ipv4.hdr_chk;
        hdr.ipv4.src         = meta.ipv4.src;
        hdr.ipv4.dst         = meta.ipv4.dst;

        // IPv6
        hdr.ipv6.version    = meta.ipv6.version;
        hdr.ipv6.tc         = meta.ipv6.tc;
        hdr.ipv6.label      = meta.ipv6.label;
        hdr.ipv6.data_len   = meta.ipv6.data_len;
        hdr.ipv6.nxt_hdr    = meta.ipv6.nxt_hdr;
        hdr.ipv6.limit      = meta.ipv6.limit;
        hdr.ipv6.src        = meta.ipv6.src;
        hdr.ipv6.dst        = meta.ipv6.dst;
