...
typedef bit<1> bit1_t;
typedef bit1_t [NUM_LABELS] lable_valid_t;
...
control FRRdplaneIngress(inout headers hdr,
    ...
    apply {
        ...
        meta.mpls_valid[0]      = hdr.mpls[0].isValid() ? 1w0b1 : 1w0b0   ;
        meta.mpls_valid[1]      = hdr.mpls[1].isValid() ? 1w0b1 : 1w0b0   ;
        meta.mpls_valid[2]      = hdr.mpls[2].isValid() ? 1w0b1 : 1w0b0   ;
        meta.mpls_valid[3]      = hdr.mpls[3].isValid() ? 1w0b1 : 1w0b0   ;
        meta.mpls_valid[4]      = hdr.mpls[4].isValid() ? 1w0b1 : 1w0b0   ;
        meta.mpls_valid[5]      = hdr.mpls[5].isValid() ? 1w0b1 : 1w0b0   ;
        meta.mpls_valid[6]      = hdr.mpls[6].isValid() ? 1w0b1 : 1w0b0   ;
        meta.mpls_valid[7]      = hdr.mpls[7].isValid() ? 1w0b1 : 1w0b0   ;
        meta.label_raw_vaild[0] = hdr.labels[0].isValid() ? 1w0b1 : 1w0b0 ;
        meta.label_raw_vaild[1] = hdr.labels[1].isValid() ? 1w0b1 : 1w0b0 ;
        meta.label_raw_vaild[2] = hdr.labels[2].isValid() ? 1w0b1 : 1w0b0 ;
        meta.label_raw_vaild[3] = hdr.labels[3].isValid() ? 1w0b1 : 1w0b0 ;
        meta.label_raw_vaild[4] = hdr.labels[4].isValid() ? 1w0b1 : 1w0b0 ;
        meta.label_raw_vaild[5] = hdr.labels[5].isValid() ? 1w0b1 : 1w0b0 ;
        meta.label_raw_vaild[6] = hdr.labels[6].isValid() ? 1w0b1 : 1w0b0 ;
        meta.label_raw_vaild[7] = hdr.labels[7].isValid() ? 1w0b1 : 1w0b0 ;
