...
control FRRdplaneIngress(inout headers hdr,
    ...
    apply {
        ...
        meta.label_valid = 8w0b0;
        meta.label_raw_vaild = hdr.labels[0].isValid() ? meta.label_valid | 8w0b00000001 : meta.label_valid ;
        meta.label_raw_vaild = hdr.labels[1].isValid() ? meta.label_valid | 8w0b00000010 : meta.label_valid ;
        meta.label_raw_vaild = hdr.labels[2].isValid() ? meta.label_valid | 8w0b00000100 : meta.label_valid ;
        meta.label_raw_vaild = hdr.labels[3].isValid() ? meta.label_valid | 8w0b00001000 : meta.label_valid ;
        meta.label_raw_vaild = hdr.labels[4].isValid() ? meta.label_valid | 8w0b00010000 : meta.label_valid ;
        meta.label_raw_vaild = hdr.labels[5].isValid() ? meta.label_valid | 8w0b00100000 : meta.label_valid ;
        meta.label_raw_vaild = hdr.labels[6].isValid() ? meta.label_valid | 8w0b01000000 : meta.label_valid ;
        meta.label_raw_vaild = hdr.labels[7].isValid() ? meta.label_valid | 8w0b10000000 : meta.label_valid ;
