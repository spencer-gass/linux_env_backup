...
control FRRdplaneIngress(inout headers hdr,
    ...
    apply {
        meta.eth      = hdr.eth      ;
        meta.vlan     = hdr.vlan     ;     // Single VLAN header/tag (IEEE 802.1q)
        meta.mpls     = hdr.mpls     ; // Max. 8 MPLS headers
        meta.labels   = hdr.labels   ; // MPLS label stack
        meta.ipv4     = hdr.ipv4     ;     // NOTE(jjardim): take a look at 'header_union'
        meta.ipv6     = hdr.ipv6     ;     // NOTE(jjardim): take a look at 'header_union'
        meta.eth_valid       = hdr.eth.isValid() ? 1w0b1 : 1w0b0;
        meta.vlan_valid      = hdr.vlan.isValid() ? 1w0b1 : 1w0b0   ;
        meta.mpls_valid = 8w0b0;
        meta.mpls_valid      = hdr.mpls[0].isValid() ? meta.mpls_valid | 8w0b00000001 : meta.mpls_valid;
        meta.mpls_valid      = hdr.mpls[1].isValid() ? meta.mpls_valid | 8w0b00000010 : meta.mpls_valid;
        meta.mpls_valid      = hdr.mpls[2].isValid() ? meta.mpls_valid | 8w0b00000100 : meta.mpls_valid;
        meta.mpls_valid      = hdr.mpls[3].isValid() ? meta.mpls_valid | 8w0b00001000 : meta.mpls_valid;
        meta.mpls_valid      = hdr.mpls[4].isValid() ? meta.mpls_valid | 8w0b00010000 : meta.mpls_valid;
        meta.mpls_valid      = hdr.mpls[5].isValid() ? meta.mpls_valid | 8w0b00100000 : meta.mpls_valid;
        meta.mpls_valid      = hdr.mpls[6].isValid() ? meta.mpls_valid | 8w0b01000000 : meta.mpls_valid;
        meta.mpls_valid      = hdr.mpls[7].isValid() ? meta.mpls_valid | 8w0b10000000 : meta.mpls_valid;
        meta.label_raw_valid = 8w0b0;
        meta.label_raw_valid = hdr.labels[0].isValid() ? meta.label_raw_valid | 8w0b00000001 : meta.label_raw_valid ;
        meta.label_raw_valid = hdr.labels[1].isValid() ? meta.label_raw_valid | 8w0b00000010 : meta.label_raw_valid ;
        meta.label_raw_valid = hdr.labels[2].isValid() ? meta.label_raw_valid | 8w0b00000100 : meta.label_raw_valid ;
        meta.label_raw_valid = hdr.labels[3].isValid() ? meta.label_raw_valid | 8w0b00001000 : meta.label_raw_valid ;
        meta.label_raw_valid = hdr.labels[4].isValid() ? meta.label_raw_valid | 8w0b00010000 : meta.label_raw_valid ;
        meta.label_raw_valid = hdr.labels[5].isValid() ? meta.label_raw_valid | 8w0b00100000 : meta.label_raw_valid ;
        meta.label_raw_valid = hdr.labels[6].isValid() ? meta.label_raw_valid | 8w0b01000000 : meta.label_raw_valid ;
        meta.label_raw_valid = hdr.labels[7].isValid() ? meta.label_raw_valid | 8w0b10000000 : meta.label_raw_valid ;
        meta.ipv4_valid      = hdr.ipv4.isValid() ? 1w0b1 : 1w0b0   ;
        meta.ipv6_valid      = hdr.ipv6.isValid() ? 1w0b1 : 1w0b0   ;
    }
}
