...
class VNP4Avmm(AvmmCommonCtrl):
    ...
    rd_flag = [MMIDescBit(name=f"{VNP4AvmmAddrs.TABLE_NAMES[i]}_rd_flag", addr=VNP4AvmmAddrs.CAM_CTRL, bit=VNP4AvmmAddrs.CAM_CTRL_RD_BIT) for i in range VNP4AvmmAddrs.NUM_CAMS]
    wr_flag = [MMIDescBit(name=f"{VNP4AvmmAddrs.TABLE_NAMES[i]}_wr_flag", addr=VNP4AvmmAddrs.CAM_CTRL, bit=VNP4AvmmAddrs.CAM_CTRL_WR_BIT) for i in range VNP4AvmmAddrs.NUM_CAMS]
    reset = [MMIDescBit(name=f"{VNP4AvmmAddrs.TABLE_NAMES[i]}_reset", addr=VNP4AvmmAddrs.CAM_CTRL, bit=VNP4AvmmAddrs.CAM_CTRL_RST_BIT) for i in range VNP4AvmmAddrs.NUM_CAMS]
    entry_in_use = [MMIDescBit(
            name=f"{VNP4AvmmAddrs.TABLE_NAMES[i]}_entry_in_use",
            addr=VNP4AvmmAddrs.CAM_CTRL,
            bit=VNP4AvmmAddrs.CAM_CTRL_ENTRY_IN_USE_BIT
    ) for i in range VNP4AvmmAddrs.NUM_CAMS]

    entry_id = [MMIDesc(name=f"{VNP4AvmmAddrs.TABLE_NAMES[i]}_entry_id", addr=VNP4AvmmAddrs.CAM_ENTRY_ID) for i in range VNP4AvmmAddrs.NUM_CAMS]
    emulation_mode = [MMIDesc(name=f"{VNP4AvmmAddrs.TABLE_NAMES[i]}_emulation_mode", addr=VNP4AvmmAddrs.CAM_EMULATION_MODE) for i in range VNP4AvmmAddrs.NUM_CAMS]
    lookup_count = [MMIDesc(name=f"{VNP4AvmmAddrs.TABLE_NAMES[i]}_lookup_count", addr=VNP4AvmmAddrs.CAM_LOOKUP_COUNT) for i in range VNP4AvmmAddrs.NUM_CAMS]
    hit_count = [MMIDesc(name=f"{VNP4AvmmAddrs.TABLE_NAMES[i]}_hit_count", addr=VNP4AvmmAddrs.CAM_HIT_COUNT) for i in range VNP4AvmmAddrs.NUM_CAMS]
    miss_count = [MMIDesc(name=f"{VNP4AvmmAddrs.TABLE_NAMES[i]}_miss_count", addr=VNP4AvmmAddrs.CAM_MISS_COUNT) for i in range VNP4AvmmAddrs.NUM_CAMS]
