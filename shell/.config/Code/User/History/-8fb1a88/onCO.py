...
class VNP4Avmm(AvmmCommonCtrl):
    ...
    cam_ctrl = [MMIDesc(name=f"{VNP4AvmmAddrs.TABLE_NAMES[i]}_cam_ctrl", addr=VNP4AvmmAddrs.CAM_CTRL + VNP4AvmmAddrs.CAM_OFFSETS[i]) for i in range VNP4AvmmAddrs.NUM_CAMS]
    rd_flag = [MMIDescBit(name=f"{VNP4AvmmAddrs.TABLE_NAMES[i]}_rd_flag", addr=VNP4AvmmAddrs.CAM_CTRL + VNP4AvmmAddrs.CAM_OFFSETS[i], bit=VNP4AvmmAddrs.CAM_CTRL_RD_BIT) for i in range VNP4AvmmAddrs.NUM_CAMS]
    wr_flag = [MMIDescBit(name=f"{VNP4AvmmAddrs.TABLE_NAMES[i]}_wr_flag", addr=VNP4AvmmAddrs.CAM_CTRL + VNP4AvmmAddrs.CAM_OFFSETS[i], bit=VNP4AvmmAddrs.CAM_CTRL_WR_BIT) for i in range VNP4AvmmAddrs.NUM_CAMS]
    reset = [MMIDescBit(name=f"{VNP4AvmmAddrs.TABLE_NAMES[i]}_reset", addr=VNP4AvmmAddrs.CAM_CTRL + VNP4AvmmAddrs.CAM_OFFSETS[i], bit=VNP4AvmmAddrs.CAM_CTRL_RST_BIT) for i in range VNP4AvmmAddrs.NUM_CAMS]
    entry_in_use = [MMIDescBit(
            name=f"{VNP4AvmmAddrs.TABLE_NAMES[i]}_entry_in_use",
    ...
    entry_id = [MMIDesc(name=f"{VNP4AvmmAddrs.TABLE_NAMES[i]}_entry_id", addr=VNP4AvmmAddrs.CAM_ENTRY_ID + VNP4AvmmAddrs.CAM_OFFSETS[i]) for i in range VNP4AvmmAddrs.NUM_CAMS]
    emulation_mode = [MMIDesc(name=f"{VNP4AvmmAddrs.TABLE_NAMES[i]}_emulation_mode", addr=VNP4AvmmAddrs.CAM_EMULATION_MODE + VNP4AvmmAddrs.CAM_OFFSETS[i]) for i in range VNP4AvmmAddrs.NUM_CAMS]
    lookup_count = [MMIDesc(name=f"{VNP4AvmmAddrs.TABLE_NAMES[i]}_lookup_count", addr=VNP4AvmmAddrs.CAM_LOOKUP_COUNT + VNP4AvmmAddrs.CAM_OFFSETS[i]) for i in range VNP4AvmmAddrs.NUM_CAMS]
    hit_count = [MMIDesc(name=f"{VNP4AvmmAddrs.TABLE_NAMES[i]}_hit_count", addr=VNP4AvmmAddrs.CAM_HIT_COUNT + VNP4AvmmAddrs.CAM_OFFSETS[i]) for i in range VNP4AvmmAddrs.NUM_CAMS]
    miss_count = [MMIDesc(name=f"{VNP4AvmmAddrs.TABLE_NAMES[i]}_miss_count", addr=VNP4AvmmAddrs.CAM_MISS_COUNT + VNP4AvmmAddrs.CAM_OFFSETS[i]) for i in range VNP4AvmmAddrs.NUM_CAMS]
    ...
    pkt_cnt_rd_data0 = MMIRODesc(
            ...
            addr=P4RouterAvmmAddrs.ADDR_PKT_CNTR_RDATA0,
            msb=31,
            lsb=0
    )
    pkt_cnt_rd_data1 = MMIRODesc(
            name="pkt_cnt_rd_data1",
            addr=P4RouterAvmmAddrs.ADDR_PKT_CNTR_RDATA1,
            msb=31,
            lsb=0
    )
    ...
    pkt_cnt_sample_req = MMIDesc(
            ...
            addr=P4RouterAvmmAddrs.ADDR_PKT_CNTR_CON,
            msb=5,
            lsb=0
    )
