...
def create_testbench(vu, lib, project_path, **kwargs):  # pylint: disable=unused-argument
    ...
    sources = [
        ...
        #     "rtl/p4_router/p4_router_vnp4_phys_port_echo_pkg.sv",
        #     "rtl/p4_router/p4_router_vnp4_phys_port_echo_wrapper.sv",
        #     "sim/p4_router/vitis_net_p4_phys_port_echo_sim_netlist.v",
            ...
            "rtl/p4_router/p4_router_queue_mmu.sv",
            "rtl/p4_router/p4_router_scheduler.sv",
            "rtl/p4_router/p4_router_uram_queue_mem.sv",
