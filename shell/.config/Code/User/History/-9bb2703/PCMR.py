...
def config_vnp4_tables(sdr, fname):
    '''
    Args:
        sdr (sdr): sdr object
        fname (str): yaml file to read from
    '''
    sdr.vnp4_intf_map_load_cam_config_from_yaml(fname)
    sdr.vnp4_lfib_load_cam_config_from_yaml(fname)
    sdr.vnp4_ipv4_fib_ingress_load_cam_config_from_yaml(fname)
    sdr.vnp4_cmp_ipv4_fib_load_cam_config_from_yaml(fname)
    sdr.vnp4_cmp_mac_fib_load_cam_config_from_yaml(fname)
    sdr.vnp4_vlan_map_load_cam_config_from_yaml(fname)
...
CLASS_CONFIG = [
    ...
    *mmi_legacy_entries("ddr",                  mmi_to_mmi.MMItoMMI,                                      (AVMM_OFFSETS.DDR_CTRL, 8, 4)),
    ...
    ["vnp4_intf_map",                           tiny_bcam_avmm.TinyBcamAvmm,                              (AVMM_OFFSETS.VNP4 + 0x2000, "intf_map", 10, 2, 46, 32)],
    ["vnp4_lfib",                               tiny_bcam_avmm.TinyBcamAvmm,                              (AVMM_OFFSETS.VNP4 + 0x4000, "lfib", 20, 3, 161, 32)],
    ["vnp4_ipv4_fib_ingress",                   tiny_bcam_avmm.TinyBcamAvmm,                              (AVMM_OFFSETS.VNP4 + 0x6000, "ipv4_fib_ingress", 64, 3, 149, 32)],
    ["vnp4_cmp_ipv4_fib",                       tiny_bcam_avmm.TinyBcamAvmm,                              (AVMM_OFFSETS.VNP4 + 0x8000, "cmp_ipv4_fib", 74, 2, 14, 32)],
    ["vnp4_cmp_mac_fib",                        tiny_bcam_avmm.TinyBcamAvmm,                              (AVMM_OFFSETS.VNP4 + 0xA000, "cmp_mac_fib", 58, 2, 14, 32)],
    ["vnp4_vlan_map",                           tiny_bcam_avmm.TinyBcamAvmm,                              (AVMM_OFFSETS.VNP4 + 0xC000, "vlan_map", 12, 2, 12, 32)],
    ["pkt_gen0",                                network_packet_generator_avmm.NetworkPacketGeneratorAvmm, (AVMM_OFFSETS.PKT_GEN0,)],
    ["pkt_gen1",                                network_packet_generator_avmm.NetworkPacketGeneratorAvmm, (AVMM_OFFSETS.PKT_GEN1,)],
    ["pkt_gen2",                                network_packet_generator_avmm.NetworkPacketGeneratorAvmm, (AVMM_OFFSETS.PKT_GEN2,)],
    ["pkt_gen3",                                network_packet_generator_avmm.NetworkPacketGeneratorAvmm, (AVMM_OFFSETS.PKT_GEN3,)],
    ["pkt_gen4",                                network_packet_generator_avmm.NetworkPacketGeneratorAvmm, (AVMM_OFFSETS.PKT_GEN4,)],
    ["pkt_gen5",                                network_packet_generator_avmm.NetworkPacketGeneratorAvmm, (AVMM_OFFSETS.PKT_GEN5,)],
    ["pkt_gen6",                                network_packet_generator_avmm.NetworkPacketGeneratorAvmm, (AVMM_OFFSETS.PKT_GEN6,)],
    ["pkt_gen7",                                network_packet_generator_avmm.NetworkPacketGeneratorAvmm, (AVMM_OFFSETS.PKT_GEN7,)],
    ["pkt_gen8",                                network_packet_generator_avmm.NetworkPacketGeneratorAvmm, (AVMM_OFFSETS.PKT_GEN8,)],
    ["pkt_gen9",                                network_packet_generator_avmm.NetworkPacketGeneratorAvmm, (AVMM_OFFSETS.PKT_GEN9,)],
