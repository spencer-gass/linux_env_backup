...
CLASS_CONFIG = [
    ...
    *mmi_legacy_entries("ddr",                  mmi_to_mmi.MMItoMMI,                                      (AVMM_OFFSETS.DDR_CTRL, 8, 4)),
    ...
    ["vnp4_intf_map",                           tiny_bcam_avmm.TinyBcamAvmm,                              (AVMM_OFFSETS.VNP4_INTF_MAP, 10, 2, 46, 32)],
    ["vnp4_lfib",                               tiny_bcam_avmm.TinyBcamAvmm,                              (AVMM_OFFSETS.VNP4_LFIB, 20, 3, 161, 32)],
    ["vnp4_ipv4_fib_ingress",                   tiny_bcam_avmm.TinyBcamAvmm,                              (AVMM_OFFSETS.VNP4_IPV4_FIB_INGRESS, 64, 3, 149, 32)],
    ["vnp4_cmp_ipv4_fib",                       tiny_bcam_avmm.TinyBcamAvmm,                              (AVMM_OFFSETS.VNP4_CMP_IPV4_FIB, 74, 2, 14, 32)],
    ["vnp4_cmp_mac_fib",                        tiny_bcam_avmm.TinyBcamAvmm,                              (AVMM_OFFSETS.VNP4_CMP_MAC_FIB, 58, 2, 14, 32)],
    ["vnp4_vlan_map",                           tiny_bcam_avmm.TinyBcamAvmm,                              (AVMM_OFFSETS.VNP4_VLAN_MAP, 12, 2, 12, 32)],
