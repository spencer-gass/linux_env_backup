#!/usr/bin/env python3
"""
Testbench dac_ad5601_ctrl_avmm
"""
...
def create_testbench(vu, lib, project_path, **kwargs):  # pylint: disable=unused-argument
    ...
    sources = [
            "rtl/dac_ad5601/dac_ad5601_ctrl_avmm.sv",
            ...
            "sim/dac_ad5601/dac_ad5601_ctrl_avmm_tb.sv",
    ...
    tb = lib.test_bench("dac_ad5601_ctrl_avmm_tb")
