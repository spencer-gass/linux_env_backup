...
def create_testbench(vu, lib, project_path, **kwargs):  # pylint: disable=unused-argument
    ...
    sources = [
            ...
            "rtl/p4_router/p4_router_pkg_phys_port_echo.sv",
            ...
            "sim/p4_router/vitis_net_p4_dpi_pkg.sv",
            "sim/p4_router/vitis_net_p4_phys_port_echo_pkg.sv",
            "sim/p4_router/p4_router_ingress_tb.sv",
    ...
    tb = lib.test_bench("p4_router_ingress_tb")
    ...
    for test_case in tb.get_tests():
        for num_ports_config in num_ports_configs:
            for converged_data_width in [8, 64]:
                ...
                if port_width_sum > converged_data_width:
                    continue
