...
#(
    ...
    ethernet_to_axis #(
        ...
        .fifo_tx_error_underflow ( {phy_fifo_tx_error_underflow, mac_fifo_tx_error_underflow } ),
        .fifo_tx_fifo_overflow   ( {phy_fifo_tx_fifo_overflow,   mac_fifo_tx_fifo_overflow   } ),
        .fifo_tx_fifo_bad_frame  ( {phy_fifo_tx_fifo_bad_frame,  mac_fifo_tx_fifo_bad_frame  } ),
        .fifo_tx_fifo_good_frame ( {phy_fifo_tx_fifo_good_frame, mac_fifo_tx_fifo_good_frame } ),
        .fifo_rx_error_bad_frame ( {phy_fifo_rx_error_bad_frame, mac_fifo_rx_error_bad_frame } ),
        .fifo_rx_error_bad_fcs   ( {phy_fifo_rx_error_bad_fcs,   mac_fifo_rx_error_bad_fcs   } ),
        .fifo_rx_fifo_overflow   ( {phy_fifo_rx_fifo_overflow,   mac_fifo_rx_fifo_overflow   } ),
        .fifo_rx_fifo_bad_frame  ( {phy_fifo_rx_fifo_bad_frame,  mac_fifo_rx_fifo_bad_frame  } ),
        .fifo_rx_fifo_good_frame ( {phy_fifo_rx_fifo_good_frame, mac_fifo_rx_fifo_good_frame } )
    );
