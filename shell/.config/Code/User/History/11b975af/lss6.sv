...
#(
    ...
    generate
        for (genvar axis_idx = 0; axis_idx < NUM_AXIS; axis_idx++) begin : gen_interfaces
            ...
            localparam int mac_idx = axis_idx;
            localparam int phy_idx = axis_idx - NUM_MACS;
            ...
            if ( axis_idx >=  MAC_GMII_OFFSET && axis_idx < MAC_GMII_OFFSET + NUM_MAC_GMIIS ) begin : gen_mac_gmii
                ...
                eth_mac_1g_fifo #(
                    ...
                    .tx_error_underflow (mac_fifo_tx_error_underflow[mac_idx]),
                    .tx_fifo_overflow   (mac_fifo_tx_fifo_overflow  [mac_idx]),
                    .tx_fifo_bad_frame  (mac_fifo_tx_fifo_bad_frame [mac_idx]),
                    .tx_fifo_good_frame (mac_fifo_tx_fifo_good_frame[mac_idx]),
                    .rx_error_bad_frame (mac_fifo_rx_error_bad_frame[mac_idx]),
                    .rx_error_bad_fcs   (mac_fifo_rx_error_bad_fcs  [mac_idx]),
                    .rx_fifo_overflow   (mac_fifo_rx_fifo_overflow  [mac_idx]),
                    .rx_fifo_bad_frame  (mac_fifo_rx_fifo_bad_frame [mac_idx]),
                    .rx_fifo_good_frame (mac_fifo_rx_fifo_good_frame[mac_idx])
                );
                ...
                if (MAC_GMII_ILA_MASK[mac_gmii_idx]) begin : gen_mac_ila
                    ila_debug gmii_ila (
                        ...
                        .probe9( {  mac_fifo_tx_error_underflow[mac_idx],
                                    mac_fifo_tx_fifo_overflow[mac_idx],
                                    mac_fifo_tx_fifo_bad_frame[mac_idx],
                                    mac_fifo_tx_fifo_good_frame[mac_idx],
                                    mac_fifo_rx_error_bad_frame[mac_idx],
                                    mac_fifo_rx_error_bad_fcs[mac_idx],
                                    mac_fifo_rx_fifo_overflow[mac_idx],
                                    mac_fifo_rx_fifo_bad_frame[mac_idx],
                                    mac_fifo_rx_fifo_good_frame[mac_idx]
                                  }  ),
                        .probe10( '0 ),
                        .probe11( '0 ),
                        .probe12( '0 ),
                ...
                eth_mac_1g_fifo #(
                    ...
                    .tx_error_underflow (phy_fifo_tx_error_underflow[phy_idx]),
                    .tx_fifo_overflow   (phy_fifo_tx_fifo_overflow  [phy_idx]),
                    .tx_fifo_bad_frame  (phy_fifo_tx_fifo_bad_frame [phy_idx]),
                    .tx_fifo_good_frame (phy_fifo_tx_fifo_good_frame[phy_idx]),
                    .rx_error_bad_frame (phy_fifo_rx_error_bad_frame[phy_idx]),
                    .rx_error_bad_fcs   (phy_fifo_rx_error_bad_fcs  [phy_idx]),
                    .rx_fifo_overflow   (phy_fifo_rx_fifo_overflow  [phy_idx]),
                    .rx_fifo_bad_frame  (phy_fifo_rx_fifo_bad_frame [phy_idx]),
                    .rx_fifo_good_frame (phy_fifo_rx_fifo_good_frame[phy_idx])
                );
                ...
                if (PHY_GMII_ILA_MASK[phy_gmiii_idx]) begin : gen_phy_ila
                    ila_debug gmii_ila (
                        ...
                        .probe9( {  phy_fifo_tx_error_underflow[phy_idx],
                                    phy_fifo_tx_fifo_overflow[phy_idx],
                                    phy_fifo_tx_fifo_bad_frame[phy_idx],
                                    phy_fifo_tx_fifo_good_frame[phy_idx],
                                    phy_fifo_rx_error_bad_frame[phy_idx],
                                    phy_fifo_rx_error_bad_fcs[phy_idx],
                                    phy_fifo_rx_fifo_overflow[phy_idx],
                                    phy_fifo_rx_fifo_bad_frame[phy_idx],
                                    phy_fifo_rx_fifo_good_frame[phy_idx]
                                  }  ),
                        .probe10( '0 ),
                        .probe11( '0 ),
                        .probe12( '0 ),
                ...
                if (PHY_XGMII_ILA_MASK[phy_xgmiii_idx]) begin : gen_phy_ila
                    ila_debug xgmii_ila (
                        ...
                        .probe1 ( {axis_tx[axis_idx].tvalid,   axis_tx[axis_idx].tready, axis_tx[axis_idx].tkeep} ),
                        .probe2 ( {axis_tx[axis_idx].tuser,    axis_tx[axis_idx].tlast}  ),
                        .probe3 ( {axis_rx[axis_idx].tdata } ),
                        .probe4 ( {axis_rx[axis_idx].tvalid, axis_rx[axis_idx].tready, axis_rx[axis_idx].tkeep} ),
                        .probe5 ( {axis_rx[axis_idx].tlast,  axis_rx[axis_idx].tuser} ),
                        .probe6( {int_axis_sreset } ),
