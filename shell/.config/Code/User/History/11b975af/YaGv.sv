    ...
    generate
        for (genvar axis_idx = 0; axis_idx < NUM_AXIS; axis_idx++) begin : gen_interfaces
            ...
            if ( axis_idx >=  MAC_GMII_OFFSET && axis_idx < MAC_GMII_OFFSET + NUM_MAC_GMIIS ) begin : gen_mac_gmii
                ...
                assign phy_fifo_tx_error_underflow[phy_idx] = 1'b0;
                assign phy_fifo_tx_fifo_overflow  [phy_idx] = 1'b0;
                assign phy_fifo_tx_fifo_bad_frame [phy_idx] = 1'b0;
                assign phy_fifo_tx_fifo_good_frame[phy_idx] = 1'b0;
                assign phy_fifo_rx_error_bad_frame[phy_idx] = 1'b0;
                assign phy_fifo_rx_error_bad_fcs  [phy_idx] = 1'b0;
                assign phy_fifo_rx_fifo_overflow  [phy_idx] = 1'b0;
                assign phy_fifo_rx_fifo_bad_frame [phy_idx] = 1'b0;
                assign phy_fifo_rx_fifo_good_frame[phy_idx] = 1'b0;
