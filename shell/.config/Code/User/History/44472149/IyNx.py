...
class NetworkPacketGeneratorAvmm(AvmmCommonCtrl):
    ...
    def _set_flow_def_wr_data(self, flow_def):
        flow_def.mac_da = 0
        flow_def.mac_sa = 0
        flow_def.ether_type = 0
        flow_def.vlan_valid = 0
        flow_def.vlan_tag = 0
        flow_def.num_mpls_labels = 0
        flow_def.mpls_label0 = 0
        flow_def.mpls_label1 = 0
        flow_def.ip_version = 0
        flow_def.ip_ihl = 0
        flow_def.ip_dscp = 0
        flow_def.ip_ecn = 0
        flow_def.ip_length = 0
        flow_def.ip_id = 0
        flow_def.ip_flags = 0
        flow_def.ip_frag_ofs = 0
        flow_def.ip_ttl = 0
        flow_def.ip_prot = 0
        flow_def.ip_hdr_chk = 0
        flow_def.ip_sa = 0
        flow_def.ip_da = 0
        flow_def.pkt_blen_mode = 0
        flow_def.pkt_blen_min = 0
        flow_def.pkt_blen_max = 0
        flow_def.payload_mode = 0
        flow_def.payload_value = 0
