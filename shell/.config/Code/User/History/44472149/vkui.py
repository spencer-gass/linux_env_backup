...
class NetworkPacketGeneratorAvmm(AvmmCommonCtrl):
    ...
    flow_def_wr_data1 = MMIDesc(
            ...
            addr=NetworkPacketGeneratorAvmmAddrs.ADDR_FLOW_DEF_WDATA
            + 1 * NetworkPacketGeneratorAvmmAddrs.REG_WIDTH_BYTES,
            msb=31,
            lsb=0
    )
    ...
    flow_def_wr_data2 = MMIDesc(
            ...
            addr=NetworkPacketGeneratorAvmmAddrs.ADDR_FLOW_DEF_WDATA
            + 2 * NetworkPacketGeneratorAvmmAddrs.REG_WIDTH_BYTES,
            msb=31,
            lsb=0
    )
    ...
    flow_def_wr_data3 = MMIDesc(
            ...
            addr=NetworkPacketGeneratorAvmmAddrs.ADDR_FLOW_DEF_WDATA
            + 3 * NetworkPacketGeneratorAvmmAddrs.REG_WIDTH_BYTES,
            msb=31,
            lsb=0
    )
    ...
    flow_def_wr_data4 = MMIDesc(
            ...
            addr=NetworkPacketGeneratorAvmmAddrs.ADDR_FLOW_DEF_WDATA
            + 4 * NetworkPacketGeneratorAvmmAddrs.REG_WIDTH_BYTES,
            msb=31,
            lsb=0
    )
    ...
    flow_def_wr_data5 = MMIDesc(
            ...
            addr=NetworkPacketGeneratorAvmmAddrs.ADDR_FLOW_DEF_WDATA
            + 5 * NetworkPacketGeneratorAvmmAddrs.REG_WIDTH_BYTES,
            msb=31,
            lsb=0
    )
    ...
    flow_def_wr_data6 = MMIDesc(
            ...
            addr=NetworkPacketGeneratorAvmmAddrs.ADDR_FLOW_DEF_WDATA
            + 6 * NetworkPacketGeneratorAvmmAddrs.REG_WIDTH_BYTES,
            msb=31,
            lsb=0
    )
    ...
    flow_def_wr_data7 = MMIDesc(
            ...
            addr=NetworkPacketGeneratorAvmmAddrs.ADDR_FLOW_DEF_WDATA
            + 7 * NetworkPacketGeneratorAvmmAddrs.REG_WIDTH_BYTES,
            msb=31,
            lsb=0
    )
    ...
    flow_def_wr_data8 = MMIDesc(
            ...
            addr=NetworkPacketGeneratorAvmmAddrs.ADDR_FLOW_DEF_WDATA
            + 8 * NetworkPacketGeneratorAvmmAddrs.REG_WIDTH_BYTES,
            msb=31,
            lsb=0
    )
    ...
    flow_def_wr_data9 = MMIDesc(
            ...
            addr=NetworkPacketGeneratorAvmmAddrs.ADDR_FLOW_DEF_WDATA
            + 9 * NetworkPacketGeneratorAvmmAddrs.REG_WIDTH_BYTES,
            msb=31,
            lsb=0
    )
    ...
    flow_def_wr_data10 = MMIDesc(
            ...
            addr=NetworkPacketGeneratorAvmmAddrs.ADDR_FLOW_DEF_WDATA
            + 10 * NetworkPacketGeneratorAvmmAddrs.REG_WIDTH_BYTES,
            msb=31,
            lsb=0
    )
    ...
    flow_def_wr_data11 = MMIDesc(
            ...
            addr=NetworkPacketGeneratorAvmmAddrs.ADDR_FLOW_DEF_WDATA
            + 11 * NetworkPacketGeneratorAvmmAddrs.REG_WIDTH_BYTES,
            msb=31,
            lsb=0
    )
    ...
    flow_def_wr_data12 = MMIDesc(
            ...
            addr=NetworkPacketGeneratorAvmmAddrs.ADDR_FLOW_DEF_WDATA
            + 12 * NetworkPacketGeneratorAvmmAddrs.REG_WIDTH_BYTES,
            msb=31,
            lsb=0
    )
    ...
    def print_all_flow_counters(self):
        ...
        for flow in range(self.last_flow_id + 1):
            print("Flow {}".format(flow))
            print("packet count: {}".format(self.get_flow_tx_packet_count(flow)))
            print("byte count:   {}".format(self.get_flow_tx_byte_count(flow)))
    ...
    def load_flow_defs_from_yaml(self, fname):
        """
        Args:
            fname (str): file to read flow definitions from.
        """
...
def create_pkt_gen_config_yaml_template(fname):
    """
    Args:
  ...
  header:
    ...
    vlan_tag: 0x81000064
    num_mpls_labels: 1
    mpls_label0: 0x12345101
    mpls_label1: 0x6789A101
    ip_version: 4
    ip_ihl: 5
    ip_dscp: 0
    ip_ecn: 0
