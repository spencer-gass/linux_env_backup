...
def create_testbench(vu, lib, project_path, **kwargs):  # pylint: disable=unused-argument
    ...
    sources = [
            ...
            "rtl/p4_router/p4_router_vnp4_echo_phys_port_pkg.sv",
            "rtl/p4_router/p4_router_vnp4_echo_phys_port_wrapper.sv",
