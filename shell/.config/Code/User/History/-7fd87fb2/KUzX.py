...
class P4RouterAvmm(AvmmCommonCtrl):
    ...
    def print_and_clear_debug_couters(self):
        ...
        print("Ingress Bus : %d".format(self.get_dbg_cntr(ING_BUS_DBG_CNT)))
        print("Policer     : %d".format(self.get_dbg_cntr(POLICER_DBG_CNT)))
        print("Enqueue     : %d".format(self.get_dbg_cntr(ENQUEUE_DBG_CNT)))
        print("Dequeue     : %d".format(self.get_dbg_cntr(DEQUEUE_DBG_CNT)))
