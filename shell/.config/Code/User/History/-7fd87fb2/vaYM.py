...
class P4RouterAvmmAddrs(IntEnum):
    ...
    ADDR_ING_CNTRS_READ_SEL = REG_WIDTH_BYTES * 23
    ADDR_ING_CNTRS_READ_DATA = REG_WIDTH_BYTES * 24
    ADDR_EGR_CNTRS_SAMPLE_CON = REG_WIDTH_BYTES * 25
    ADDR_EGR_CNTRS_READ_SEL = REG_WIDTH_BYTES * 26
    ADDR_EGR_CNTRS_READ_DATA = REG_WIDTH_BYTES * 27
