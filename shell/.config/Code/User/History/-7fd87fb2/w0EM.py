...
class P4RouterAvmm(AvmmCommonCtrl):
    ...
    def print_port_ingress_and_egress_counters(self, port, print_zeros=False):
        ...
        ing_fifo_ovf_cnt = self.read_ingress_counter(port, P4RouterAvmmAddrs.ING_ASYNC_FIFO_OVERFLOW_INDEX)
    ...
    def print_all_ingress_and_egress_coutners(self, print_zeros=False):
        for port in range(self.num_ing_phys_ports):
            self.print_port_ingress_and_egress_counters(port)
