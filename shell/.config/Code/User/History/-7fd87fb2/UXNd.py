...
class P4RouterAvmmAddrs(IntEnum):
    ...
    ADDR_PKT_CNTR_CON = REG_WIDTH_BYTES * 36
    ADDR_PKT_CNTR_RDATA0 = REG_WIDTH_BYTES * 37
    ADDR_PKT_CNTR_RDATA1 = REG_WIDTH_BYTES * 38
    ...
    ING_PORTS_PKT_CNT_SAMPLE_REQ = 1 << 0
    ING_BUS_PKT_CNT_SAMPLE_REQ = 1 << 1
    QSYS_IN_PKT_CNT_SAMPLE_REQ = 1 << 2
    ENQUEUE_PKT_CNT_SAMPLE_REQ = 1 << 3
    DEQUEUE_PKT_CNT_SAMPLE_REQ = 1 << 4
    EGR_PORTS_PKT_CNT_SAMPLE_REQ = 1 << 5
    ALL_PKT_CNT_SAMPLE_REQ = 0x3F
...
class P4RouterAvmm(AvmmCommonCtrl):
    ...
    def config_ing_policer(self, port, cir, cbs):
        ...
        self.wr_ing_policer_cbs_table(port, cbs)
        ...
        self.wr_ing_policer_cir_table(port, cir_bytes_per_cycle_hex)
