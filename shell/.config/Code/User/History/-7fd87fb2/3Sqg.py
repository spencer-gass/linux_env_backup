...
class P4RouterAvmm(AvmmCommonCtrl):
    ...
    def __init__(self, sdr_host, offset):
        ...
        self.NUM_COUNTERS_PER_PORT = 5
        self.ingress_counters = [[0 for i in range(self.NUM_COUNTERS_PER_PORT)] for j in range(self.num_ing_phys_ports)]
        self.egress_counters = [[0 for i in range(self.NUM_COUNTERS_PER_PORT)] for j in range(self.num_egr_phys_ports)]
