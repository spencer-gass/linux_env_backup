...
class P4RouterAvmm(AvmmCommonCtrl):
    ...
    def read_drop_counter(self, queue, type):
        return self.drop_counter_op(queue, type, self.READ)

    def read_and_clear_drop_counter(self, queue, type):
        return self.drop_counter_op(queue, type, self.READ_AND_CLEAR)

    def clear_all_drop_counters(self):
        return self.drop_counter_op(0, 0, self.CLEAR_ALL)
