...
control FRRdplaneIngress(inout headers hdr,
    ...
    *************************************************************************/
    ...
    apply {
        ...
        mpls_update_in.new_labels        = meta.mpls_stack_vec;
        mpls_update_in.new_labels_valid  = meta.mpls_valid_vec;
        mpls_update_in.old_labels[31:0]  = hdr.mpls[0];
