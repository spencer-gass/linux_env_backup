...
control FRRdplaneIngress(inout headers hdr,
    ...
    *************************************************************************/
    ...
    action ler_push (MplsLabel[8] out_stack, MacAddr src_addr, MacAddr dst_addr, PortId port) {
        /* Ethernet */
        hdr.eth.src = src_addr;
        hdr.eth.dst = dst_addr;
        hdr.eth.type = TYPE_MPLS;
    ...
    action lsr_push(MplsLabel[8] out_label, MacAddr src_addr, MacAddr dst_addr, PortId port) {
        /* Ethernet */
        hdr.eth.src = src_addr;
        hdr.eth.dst = dst_addr;
