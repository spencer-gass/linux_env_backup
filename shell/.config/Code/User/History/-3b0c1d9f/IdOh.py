    ...
    for test_case in tb.get_tests():
        for num_ports_config in num_ports_configs:
                test_case.add_config(
                    ...
                    parameters={
                            'NUM_8B_ING_PORTS': num_ports_config['8B'],
                            'NUM_16B_ING_PORTS': num_ports_config['16B'],
                            'NUM_32B_ING_PORTS': num_ports_config['32B'],
                            'NUM_64B_ING_PORTS': num_ports_config['64B'],
                            'NUM_8B_EGR_PORTS': num_ports_config['8B'],
                            'NUM_16B_EGR_PORTS': num_ports_config['16B'],
                            'NUM_32B_EGR_PORTS': num_ports_config['32B'],
                            'NUM_64B_EGR_PORTS': num_ports_config['64B']
                    },
                )
