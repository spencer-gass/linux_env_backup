...
proc ::kepler::vivado::ips::export_ip_info {ip_name args} {
    ...
    set temp [::huddle exists ip_info config $key]
    puts "debug: key in huddle: $temp"
    if {([lrange [split $ipdef :] 0 2] == {xilinx.com ip vitis_net_p4}) && [::huddle exists ip_info config $key]} {
