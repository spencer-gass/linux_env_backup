...
#(
    ...
    logic [NUM_MACS-1:0] mp_fifo_tx_error_underflow;
    logic [NUM_MACS-1:0] mp_fifo_tx_fifo_overflow;
    logic [NUM_MACS-1:0] mp_fifo_tx_fifo_bad_frame;
    logic [NUM_MACS-1:0] mp_fifo_tx_fifo_good_frame;
    logic [NUM_MACS-1:0] mp_fifo_rx_error_bad_frame;
    logic [NUM_MACS-1:0] mp_fifo_rx_error_bad_fcs;
    logic [NUM_MACS-1:0] mp_fifo_rx_fifo_overflow;
    logic [NUM_MACS-1:0] mp_fifo_rx_fifo_bad_frame;
    logic [NUM_MACS-1:0] mp_fifo_rx_fifo_good_frame;
