...
#(
    ...
    parameter string POINT_LINK_TYPE              = "GMII", // Valid options are GMII, XGMII, PPL, and AXIS
    ...
    generate
        case (POINT_LINK_TYPE)
            ...
            default: begin
                $fatal("Invalid point link type: %s. Valid options are GMII, XGMII, PPL, and AXIS", POINT_LINK_TYPE);
            end
        endcase
    endgenerate
