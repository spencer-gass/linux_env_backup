...
#(
    ...
    // Only one of these interfaces is active and is selected at build time


    AXIS_int.Slave      ppl_ins                 [0:0][0:0][0:0],
    AXIS_int.Master     ppl_outs                [0:0][0:0][0:0],

    GMII_int.Master     phy_gmiis,
    Clock_int.Input     clk_ifc_phy_gmiis,
    Reset_int.ResetIn   sreset_ifc_phy_gmiis,

    XGMII_int.Master    phy_xgmiis,

    GMII_int.Slave      mac_gmiis,
    Clock_int.Input     clk_ifc_mac_gmiis,
    Reset_int.ResetIn   sreset_ifc_mac_gmiis,

    XGMII_int.Slave     mac_xgmiis,
    Clock_int.Input     clk_ifc_mac_xgmiis,
    Reset_int.ResetIn   sreset_ifc_mac_xgmiis,

    AXIS_int.Slave      mac_axis_ins,
    AXIS_int.Master     mac_axis_outs,
