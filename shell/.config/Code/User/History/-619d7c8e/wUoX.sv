...
#(
    ...
    parameter string POINT_INTF_TYPE              = "GMII", // Valid options are GMII_MASTER, GMII_SLAVE, XGMII_MASTER, XGMII_SLAVE, PPL, and AXIS
    ...
    AXIS_int.Slave      point_ppl_in    [0:0][0:0][0:0],
    AXIS_int.Master     point_ppl_out   [0:0][0:0][0:0],

    GMII_int.Master     point_phy_gmii,
    Clock_int.Input     point_clk_ifc_phy_gmii,
    Reset_int.ResetIn   point_sreset_ifc_phy_gmii,

    XGMII_int.Master    point_phy_xgmii,

    GMII_int.Slave      point_mac_gmii,
    Clock_int.Input     point_clk_ifc_mac_gmii,
    Reset_int.ResetIn   point_sreset_ifc_mac_gmii,

    XGMII_int.Slave     point_mac_xgmii,
    Clock_int.Input     point_clk_ifc_mac_xgmii,
    Reset_int.ResetIn   point_sreset_ifc_mac_xgmii,

    AXIS_int.Slave      point_mac_axis_in,
    AXIS_int.Master     point_mac_axis_out,
        ...
        case (POINT_INTF_TYPE)
            "GMII_MASTER": begin
                ...
                eth_mac_1g_fifo #(
                    ...
                    .rx_clk             ( point_clk_ifc_phy_gmii.clk        ),
                    .rx_rst             ( point_sreset_ifc_phy_gmii.reset   ),

                    .tx_clk             ( clk_ifc_phy_gmii.clk              ),
                    .tx_rst             ( sreset_ifc_phy_gmii.reset         ),
                    ...
                    .gmii_rxd           ( phy_gmii.tx_d                    ),
                    .gmii_rx_dv         ( phy_gmii.tx_en                   ),
                    .gmii_rx_er         ( phy_gmii.tx_er                   ),

                    .gmii_txd           ( phy_gmii.rx_d                    ),
                    .gmii_tx_en         ( phy_gmii.rx_dv                   ),
                    .gmii_tx_er         ( phy_gmii.rx_er                   ),
                ...
                if (PHY_GMII_ILA_MASK[idx]) begin : gen_mac_ila
                    ila_debug gmii_ila (
                        .clk   ( int_axis_clk  ),
                        ...
                        .probe9( {  mac_fifo_tx_error_underflow[i],
                                    mac_fifo_tx_fifo_overflow[i],
                                    mac_fifo_tx_fifo_bad_frame[i],
                                    mac_fifo_tx_fifo_good_frame[i],
                                    mac_fifo_rx_error_bad_frame[i],
                                    mac_fifo_rx_error_bad_fcs[i],
                                    mac_fifo_rx_fifo_overflow[i],
                                    mac_fifo_rx_fifo_bad_frame[i],
                                    mac_fifo_rx_fifo_good_frame[i]
                                }),
            ...
            "GMII_SLAVE": begin
                ...
                eth_mac_1g_fifo #(
                    ...
                    .gmii_rxd           ( mac_gmiis.tx_d                   ),
                    .gmii_rx_dv         ( mac_gmiis.tx_en                  ),
                    .gmii_rx_er         ( mac_gmiis.tx_er                  ),

                    .gmii_txd           ( mac_gmiis.rx_d                   ),
                    .gmii_tx_en         ( mac_gmiis.rx_dv                  ),
                    .gmii_tx_er         ( mac_gmiis.rx_er                  ),
            ...
            "XGMII": begin
                ...
                if (PHY_XGMII_ILA_MASK[idx]) begin : gen_phy_ila
                    ila_debug xgmii_ila (
                        ...
                        .probe1 ( {int_phy_axis_in[k].tvalid,
                                  int_phy_axis_in[k].tready,
                                  int_phy_axis_in[k].tkeep
                                }),
                        .probe2 ( {int_phy_axis_in[k].tuser,    int_phy_axis_in[k].tlast}  ),
                        .probe3 ( {int_phy_axis_out[k].tdata } ),
                        .probe4 ( {int_phy_axis_out[k].tvalid,
                                  int_phy_axis_out[k].tready,
                                  int_phy_axis_out[k].tkeep
                                }),
                        ...
                        .probe13( { phy_fifo_tx_error_underflow[k],
                                    phy_fifo_tx_fifo_overflow[k],
                                    phy_fifo_tx_fifo_bad_frame[k],
                                    phy_fifo_tx_fifo_good_frame[k],
                                    phy_fifo_rx_error_bad_frame[k],
                                    phy_fifo_rx_error_bad_fcs[k],
                                    phy_fifo_rx_fifo_overflow[k],
                                    phy_fifo_rx_fifo_bad_frame[k],
                                    phy_fifo_rx_fifo_good_frame[k]
                                  }),
            ...
            default: begin
                $fatal("Invalid point link type: %s. Valid options are GMII_MASTER, GMII_SLAVE, XGMII_MASTER, XGMII_SLAVE, PPL, and AXIS", POINT_INTF_TYPE);
            end
        endcase
    endgenerate
            ...
            if ( k >=  PHY_GMII_OFFSET && k < PHY_GMII_OFFSET + NUM_PHY_GMIIS ) begin : gen_gmii
                ...
                if (PHY_GMII_ILA_MASK[idx]) begin : gen_phy_ila
                    ila_debug gmii_ila (
                        ...
                        .probe9( {  phy_fifo_tx_error_underflow[k],
                                    phy_fifo_tx_fifo_overflow[k],
                                    phy_fifo_tx_fifo_bad_frame[k],
                                    phy_fifo_tx_fifo_good_frame[k],
                                    phy_fifo_rx_error_bad_frame[k],
