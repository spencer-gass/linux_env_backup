...
control MyProcessing(inout headers hdr,
    ...
    action IPv4ChkVerify() {
        ...
        is_not_equal |= chksum[0];
        is_not_equal |= chksum[1];
        is_not_equal |= chksum[2];
        is_not_equal |= chksum[3];
        is_not_equal |= chksum[4];
        is_not_equal |= chksum[5];
        is_not_equal |= chksum[6];
        is_not_equal |= chksum[7];
        is_not_equal |= chksum[8];
        is_not_equal |= chksum[9];
        is_not_equal |= chksum[10];
        is_not_equal |= chksum[11];
        is_not_equal |= chksum[12];
        is_not_equal |= chksum[13];
        is_not_equal |= chksum[14];
