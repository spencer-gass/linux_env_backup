...
control MyProcessing(inout headers hdr,
    ...
    action IPv4ChkVerify() {
        ...
        chksum += ipv4.version << 12 | ipv4.hdr_len << 8 | ipv4.tos;
        chksum += ipv4.length;
        chksum += ipv4.id;
        chksum += (ipv4.flags << 13) | ipv4.offset;
        chksum += ipv4.ttl << 8 | ipv4.protocol;
        chksum += ipv4.src[31:16];
        chksum += ipv4.src[15:0];
        chksum += ipv4.dst[31:16];
        chksum += ipv4.dst[15:0];
