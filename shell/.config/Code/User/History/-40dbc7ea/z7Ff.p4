...
control MyProcessing(inout headers hdr,
    ...
    action IPv4ChkVerify() {
        ...
        chksum[15:0] = chksum[15:0] ^ hdr.ipv4.hdr_chk;
        is_not_equal = chksum[0:0] | chksum[1:1] | chksum[2:2]   | chksum[3:3]   | chksum[4:4]   | chksum[5:5]   | chksum[6:6]   | chksum[7:7] |
                       chksum[8:8] | chksum[9:9] | chksum[10:10] | chksum[11:11] | chksum[12:12] | chksum[13:13] | chksum[14:14] | chksum[15:15];
    ...
    action IPv4TtlAndChksumUpdate(){
            ...
            // if-statements not supported on pre-production Xilins p4 compiler
            // if (hdr.ipv4.hdr_chk == 0xFFFF) {
            //     hdr.ipv4.hdr_chk = 0x0000;
            // }
            // equivilent statement without using an if
            bit<17> hdr_chk_17 = 0;
            bit<15> zero_pad = 0;
            hdr_chk_17 = (zero_pad[0:0] ++ hdr.ipv4.hdr_chk) + 1;
            hdr.ipv4.hdr_chk = hdr.ipv4.hdr_chk + (zero_pad[14:0] ++ hdr_chk_17[16:16]);
    }
