...
# Need to cd to the project dir because P4_PATH property is a relative path from the project directory
set synth_dir [pwd]
set project_dir ""
...
if {[regexp {^(.*?hdl\/vivado\/workspace\/.*?)(\/)} $synth_dir match project_dir]} {
    ...
    error "Expected working directory to be of the form hdl/vivado/workspace/<proejct_dir> but it is $synth_dir"
}
