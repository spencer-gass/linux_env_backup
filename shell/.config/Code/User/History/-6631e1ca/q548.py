...
class DACAD5601MMI:
    ...
    dac_data = MMIDesc(name="dac_data", addr=DACAD5601MMIAddrs.ADDR_DAC_REG, msb=13, lsb=6)

    en_mmi_ctrl = MMIRODescBit(name="en_avmm_ctrl", addr=DACAD5601MMIAddrs.ADDR_EN_MMI_CTRL, bit=0)
