...
class DACAD5601MMI:
    ...
    module_version = MMIRODesc(name="module_version", addr=DACAD5601MMIAdders.ADDR_MODULE_VERSION)
    ...
    dac_data = MMIDesc(name="dac_data", addr=DACAD5601MMIAdders.ADDR_DAC_REG, msb=13, lsb=6)

    en_mmi_ctrl = MMIRODescBit(name="en_avmm_ctrl", addr=DACAD5601MMIAdders.ADDR_EN_MMI_CTRL, bit=0)
