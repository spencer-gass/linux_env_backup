...
class FlowDef():
    ...
    def __init__(self, flow_def_dict=None):
        ...
        if flow_def_dict is None:
            ...
            self.pkt_blen_mode = flow_def_dict["header"]["pkt_blen_mode"]
            self.pkt_blen_min = flow_def_dict["header"]["pkt_blen_min"]
            self.pkt_blen_max = flow_def_dict["header"]["pkt_blen_max"]
            self.payload_mode = flow_def_dict["header"]["payload_mode"]
            self.payload_value = flow_def_dict["header"]["payload_value"]
