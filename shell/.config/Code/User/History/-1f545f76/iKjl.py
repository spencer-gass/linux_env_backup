...
class FlowDef():
    ...
    def __init__(self, flow_def_dict=None):
        ...
        if flow_def_dict is None:
            ...
            self.mac_da = flow_def_dict["mac_da"]
            self.mac_sa = flow_def_dict["mac_sa"]
            self.ether_type = flow_def_dict["ether_type"]
            self.vlan_valid = flow_def_dict["vlan_valid"]
            self.vlan_tag = flow_def_dict["vlan_tag"]
            self.num_mpls_labels = flow_def_dict["num_mpls_labels"]
            self.mpls_label0 = flow_def_dict["mpls_label0"]
            self.mpls_label1 = flow_def_dict["mpls_label1"]
            self.ip_version = flow_def_dict["ip_version"]
            self.ip_ihl = flow_def_dict["ip_ihl"]
            self.ip_dscp = flow_def_dict["ip_dscp"]
            self.ip_ecn = flow_def_dict["ip_ecn"]
            self.ip_length = flow_def_dict["ip_length"]
            self.ip_id = flow_def_dict["ip_id"]
            self.ip_flags = flow_def_dict["ip_flags"]
            self.ip_frag_ofs = flow_def_dict["ip_frag_ofs"]
            self.ip_ttl = flow_def_dict["ip_ttl"]
            self.ip_prot = flow_def_dict["ip_prot"]
            self.ip_hdr_chk = flow_def_dict["ip_hdr_chk"]
            self.ip_sa = flow_def_dict["ip_sa"]
            self.ip_da = flow_def_dict["ip_da"]
