...
mkdir -p project-spec/meta-user/recipes-net/frr_dplane/files

cp $VNP4_XCIX project-spec/meta-user/recipes-net/libvitisnetp4drv/files/vnp4_runtime_driver.zip
